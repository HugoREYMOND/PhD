...
Carbotech brand proposes some sintered alumina tubes "AluSIK-60 ZA".
...
\begin{table}[H]
    ...
    \begin{tabular}{l c}
        ...
        \bottomrule
    \end{tabular}
    \caption{Maximum temp = 1600$^\circ$C,\\
    Bulk density = 2.7 g/cm$^3$,\\
    thermal expansion coefficient = 5.5 $\times 10^{-6} K^{-1}$,\\
...
Carbotech brand proposes some sintered alumina tubes "AluSIK-99 ZA".
...
R 207 & 7 x 4 \\
    ...
    thermal expansion coefficient = 5 $\times 10^{-6} K^{-1}$,\\
